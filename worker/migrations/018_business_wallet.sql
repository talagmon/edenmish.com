-- Migration 018: Passwordless business accounts and prepaid delivery wallets.
-- Additive only. Shopify remains checkout; Worker + D1 own wallet and delivery state.
...
ALTER TABLE orders ADD COLUMN business_account_id INTEGER;
ALTER TABLE orders ADD COLUMN wallet_reservation_id TEXT;
