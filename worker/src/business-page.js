...
<main class="shell">
  <header class="top">
    ...
    <div class="top-actions"><a id="header-new-delivery" class="btn primary hidden" href="${storefront}/booking.html?business=1" aria-label="משלוח חדש"><span class="material-symbols-outlined" aria-hidden="true">add</span><span class="label">משלוח חדש</span></a><button id="logout" class="ghost hidden" aria-label="יציאה"><span class="material-symbols-outlined" aria-hidden="true">logout</span><span class="label">יציאה</span></button></div>
  </header>
